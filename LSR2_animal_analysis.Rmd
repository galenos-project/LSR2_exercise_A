...
Rationale for conclusions for indirectness: **[1] Effect of exercise on behavioural outcomes in PTSD: Moderate risk of indirectness** 
...
For both the induction of the disease model and the effects of exercise, there was some agreement between the effect sizes measured using these different outcomes when applied to the same cohort of animals. The data are however too sparse to allow firm conclusions at the level of outcome measure pairs.
