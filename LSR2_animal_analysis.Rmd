...
**Table 2** below gives a summary of the included studies for the effect of exercise interventions. N represents an aggregate of animals contributing to outcomes reported from control and treatment groups, and if the same control group has contributed to more than one experiment, it will be counted twice.
...
Figure 3.4.1 shows the risk of bias summary for studies investigating the effect of exercise on other behavioural outcomes in animals. The risk of bias assessment was performed using the SyRCLE RoB tool.
...
Figure 3.4.2 shows the reporting completeness summary for studies investigating the effect of exercise on other behavioural outcomesin animals. The reporting completeness assessment was performed using the ARRIVE guidelines.
...
Exercise interventions had a pooled effect on other behavioural outcomes induced by single prolonged stress of SMD = `r round(SMD_S_OB[['beta']], 3)` , (95% CI: `r round(SMD_S_OB[['ci.lb']], 3)` to `r round(SMD_S_OB[['ci.ub']], 3)`; 95% PrI: `r round(predict(SMD_S_OB)$pi.lb, 3)` to `r round(predict(SMD_S_OB)$pi.ub, 3)`).
...
When the $\rho$ value is assumed to be 0.2, exercise had a pooled effect on other behavioural outcomes of **SMD = `r SMD_S_OB_rho0.2[["beta"]]`** (95% CI: `r SMD_S_OB_rho0.2[["ci.lb"]]` to `r SMD_S_OB_rho0.2[["ci.ub"]]`; 95% PrI: `r predict(SMD_S_OB_rho0.2)$pi.lb` to `r predict(SMD_S_OB_rho0.2)$pi.ub`).

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_OB_rho0.8 <- run_ML_SMD(df, "TvC", "Other behavioural", 0.8)
```

When the $\rho$ value is assumed to be 0.8, exercise had a pooled effect on other behavioural outcomes of **SMD = `r SMD_S_OB_rho0.8[["beta"]]`** (95% CI: `r SMD_S_OB_rho0.8[["ci.lb"]]` to `r SMD_S_OB_rho0.8[["ci.ub"]]`; 95% PrI: `r predict(SMD_S_OB_rho0.8)$pi.lb` to `r predict(SMD_S_OB_rho0.8)$pi.ub`).
...
Figure 3.5.1 shows the risk of bias summary for studies investigating the effect of exercise on BDNF in animals. The risk of bias assessment was performed using the SyRCLE RoB tool.
...
Figure 3.5.2 shows the reporting completeness summary for studies investigating the effect of exercise on BDNF in animals. The reporting completeness assessment was performed using the ARRIVE guidelines.
...
The effect of exercise on BDNF in animals using SMD as the effect size is shown in Figure 3.5.3. The pooled estimate for SMD across all individual comparisons is displayed as a diamond shape at the bottom of the plot. Dotted lines indicate the prediction interval of the pooled estimate.
...
Exercise had a pooled effect on BDNF of SMD = `r round(SMD_S_B[['beta']], 3)` , (95% CI: `r round(SMD_S_B[['ci.lb']], 3)` to `r round(SMD_S_B[['ci.ub']], 3)`; 95% PrI: `r round(predict(SMD_S_B)$pi.lb, 3)` to `r round(predict(SMD_S_B)$pi.ub, 3)`).
...
Figure 3.5.4.1 displays the estimates for the pooled SMD when comparisons are stratified by sex of the animal. Whiskers indicate the 95% confidence interval of each estimate. The overall pooled SMD, not stratified by sex, is displayed as a diamond shape at the bottom of the plot.
...
When the $\rho$ value is assumed to be 0.2, exercise had a pooled effect on BDNF of **SMD = `r SMD_S_B_rho0.2[["beta"]]`** (95% CI: `r SMD_S_B_rho0.2[["ci.lb"]]` to `r SMD_S_B_rho0.2[["ci.ub"]]`; 95% PrI: `r predict(SMD_S_B_rho0.2)$pi.lb` to `r predict(SMD_S_B_rho0.2)$pi.ub`).

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_B_rho0.8 <- run_ML_SMD(df, "TvC", "BDNF", 0.8)
```

When the $\rho$ value is assumed to be 0.8, exercise had a pooled effect on BDNF of **SMD = `r SMD_S_B_rho0.8[["beta"]]`** (95% CI: `r SMD_S_B_rho0.8[["ci.lb"]]` to `r SMD_S_B_rho0.8[["ci.ub"]]`; 95% PrI: `r predict(SMD_S_B_rho0.8)$pi.lb` to `r predict(SMD_S_B_rho0.8)$pi.ub`).
...
Figure 3.6.1 shows the risk of bias summary for studies investigating the effect of exercise on biological stress response in animals. The risk of bias assessment was performed using the SyRCLE RoB tool.
...
Figure 3.6.2 shows the reporting completeness summary for studies investigating the effect of exercise on biological stress response in animals. The reporting completeness assessment was performed using the ARRIVE guidelines.
...
The effect of exercise on biological stress response in animals using SMD as the effect size is shown in Figure 3.6.3. The pooled estimate for SMD across all individual comparisons is displayed as a diamond shape at the bottom of the plot. Dotted lines indicate the prediction interval of the pooled estimate.
...
Exercise interventions had a pooled effect on biological stress response induced by single prolonged stress of SMD = `r round(SMD_S_StR[['beta']], 3)` , (95% CI: `r round(SMD_S_StR[['ci.lb']], 3)` to `r round(SMD_S_StR[['ci.ub']], 3)`; 95% PrI: `r round(predict(SMD_S_StR)$pi.lb, 3)` to `r round(predict(SMD_S_StR)$pi.ub, 3)`.
...
Figure 3.6.4.1 displays the estimates for the pooled SMD when comparisons are stratified by sex of the animal. Whiskers indicate the 95% confidence interval of each estimate. The overall pooled SMD, not stratified by sex, is displayed as a diamond shape at the bottom of the plot.
...
Figure 3.6.4.5 displays the estimates for the pooled SMD when comparisons are stratified by how many of the SyRCLE risk of bias assessment criteria (of which there are 10) that the experiment met. Whiskers indicate the 95% confidence interval of each estimate. The overall pooled SMD, not stratified by SyRCLE Risk of Bias, is displayed as a diamond shape at the bottom of the plot.
...
Figure 3.6.4.6 displays the estimates for the pooled SMD when comparisons are stratified by whether of not any of the SyRCLE Risk of bias domains were rated as low risk of bias. Whiskers indicate the 95% confidence interval of each estimate. The overall pooled SMD, not stratified by SyRCLE Risk of Bias, is displayed as a diamond shape at the bottom of the plot.
...
When the $\rho$ value is assumed to be 0.2, exercise had a pooled effect on biological stress response of **SMD = `r SMD_S_StR_rho0.2[["beta"]]`** (95% CI: `r SMD_S_StR_rho0.2[["ci.lb"]]` to `r SMD_S_StR_rho0.2[["ci.ub"]]`; 95% PrI: `r predict(SMD_S_StR_rho0.2)$pi.lb` to `r predict(SMD_S_StR_rho0.2)$pi.ub`).

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_StR_rho0.8 <- run_ML_SMD(df, "TvC", "Stress response", 0.8)
```

When the $\rho$ value is assumed to be 0.8, exercise had a pooled effect on biological stress response of **SMD = `r SMD_S_StR_rho0.8[["beta"]]`** (95% CI: `r SMD_S_StR_rho0.8[["ci.lb"]]` to `r SMD_S_StR_rho0.8[["ci.ub"]]`; 95% PrI: `r predict(SMD_S_StR_rho0.8)$pi.lb` to `r predict(SMD_S_StR_rho0.8)$pi.ub`).
...
## 3.8 Outcome 9: Other neurobiological outcomes

### 3.8.1 Risks of bias

Figure 3.8.1 shows the risk of bias summary for studies investigating the effect of exercise on other neurobiological outcomes in animals. The risk of bias assessment was performed using the SyRCLE RoB tool.
...
Figure 3.8.2 shows the reporting completeness summary for studies investigating the effect of exercise on other neurobiological outcomes in animals. The reporting completeness assessment was performed using the ARRIVE guidelines.
...
Exercise had a pooled effect on other neurobiological outcomes of SMD = `r round(SMD_S_OthN[['beta']], 3)` , (95% CI: `r round(SMD_S_OthN[['ci.lb']], 3)` to `r round(SMD_S_OthN[['ci.ub']], 3)`; 95% PrI: `r round(predict(SMD_S_OthN)$pi.lb, 3)` to `r round(predict(SMD_S_OthN)$pi.ub, 3)`).
...
When the $\rho$ value is assumed to be 0.2, exercise had a pooled effect on other neurobiological outcomes of **SMD = `r SMD_S_OthN_rho0.2[["beta"]]`** (95% CI: `r SMD_S_OthN_rho0.2[["ci.lb"]]` to `r SMD_S_OthN_rho0.2[["ci.ub"]]`; 95% PrI: `r predict(SMD_S_OthN_rho0.2)$pi.lb` to `r predict(SMD_S_OthN_rho0.2)$pi.ub`).

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_OthN_rho0.8 <- run_ML_SMD(df, "TvC", "Other neurobiological", 0.8)
```

When the $\rho$ value is assumed to be 0.8, exercise had a pooled effect on other neurobiological outcomes of **SMD = `r SMD_S_OthN_rho0.8[["beta"]]`** (95% CI: `r SMD_S_OthN_rho0.8[["ci.lb"]]` to `r SMD_S_OthN_rho0.8[["ci.ub"]]`; 95% PrI: `r predict(SMD_S_OthN_rho0.8)$pi.lb` to `r predict(SMD_S_OthN_rho0.8)$pi.ub`).
...
# 2 Effects of model induction (SPS)
...
Figure 2.4.1 shows the risk of bias summary for studies investigating the effect of single prolonged stress on other behavioural outcomes in animals. The risk of bias assessment was performed using the SyRCLE RoB tool.
...
Single prolonged stress had a pooled effect on other behaviours of SMD = `r round(SMD_S_OB[['beta']], 3)` , (95% CI: `r round(SMD_S_OB[['ci.lb']], 3)` to `r round(SMD_S_OB[['ci.ub']], 3)`; 95% PrI: `r round(predict(SMD_S_OB)$pi.lb, 3)` to `r round(predict(SMD_S_OB)$pi.ub, 3)`).
...
When the $\rho$ value is assumed to be 0.2, single prolonged stress had a pooled effect on other behaviours of **SMD = `r SMD_S_OB_rho0.2[["beta"]]`** (95% CI: `r SMD_S_OB_rho0.2[["ci.lb"]]` to `r SMD_S_OB_rho0.2[["ci.ub"]]`; 95% PrI: `r predict(SMD_S_OB_rho0.2)$pi.lb` to `r predict(SMD_S_OB_rho0.2)$pi.ub`).

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_OB_rho0.8 <- run_ML_SMD(df, "CvS", "Other behavioural", 0.8)
```

When the $\rho$ value is assumed to be 0.8, single prolonged stress had a pooled effect on other behaviours of **SMD = `r SMD_S_OB_rho0.8[["beta"]]`** (95% CI: `r SMD_S_OB_rho0.8[["ci.lb"]]` to `r SMD_S_OB_rho0.8[["ci.ub"]]`; 95% PrI: `r predict(SMD_S_OB_rho0.8)$pi.lb` to `r predict(SMD_S_OB_rho0.8)$pi.ub`).
...
Single prolonged stress had a pooled effect on other behaviours of SMD = `r round(SMD_S_B[['beta']], 3)` , (95% CI: `r round(SMD_S_B[['ci.lb']], 3)` to `r round(SMD_S_B[['ci.ub']], 3)`; 95% PrI: `r round(predict(SMD_S_B)$pi.lb, 3)` to `r round(predict(SMD_S_B)$pi.ub, 3)`).
...
When the $\rho$ value is assumed to be 0.2, single prolonged stress had a pooled effect on BDNF of **SMD = `r SMD_S_B_rho0.2[["beta"]]`** (95% CI: `r SMD_S_B_rho0.2[["ci.lb"]]` to `r SMD_S_B_rho0.2[["ci.ub"]]`; 95% PrI: `r predict(SMD_S_B_rho0.2)$pi.lb` to `r predict(SMD_S_B_rho0.2)$pi.ub`).

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_B_rho0.8 <- run_ML_SMD(df, "CvS", "BDNF", 0.8)
```

When the $\rho$ value is assumed to be 0.8, single prolonged stress had a pooled effect on BDNF of **SMD = `r SMD_S_B_rho0.8[["beta"]]`** (95% CI: `r SMD_S_B_rho0.8[["ci.lb"]]` to `r SMD_S_B_rho0.8[["ci.ub"]]`; 95% PrI: `r predict(SMD_S_B_rho0.8)$pi.lb` to `r predict(SMD_S_B_rho0.8)$pi.ub`).
...
Figure 2.6.1 shows the risk of bias summary for studies investigating the effect of model induction on biological stress response in animals. The risk of bias assessment was performed using the SyRCLE RoB tool.
...
Figure 2.6.2 shows the reporting completeness summary for studies investigating the effect of model induction on biological stress response in animals. The reporting completeness assessment was performed using the ARRIVE guidelines.
...
Single prolonged stress had a pooled effect on biological stress response of SMD = `r round(SMD_S_StR[['beta']], 3)` , (95% CI: `r round(SMD_S_StR[['ci.lb']], 3)` to `r round(SMD_S_StR[['ci.ub']], 3)`; 95% PrI: `r round(predict(SMD_S_StR)$pi.lb, 3)` to `r round(predict(SMD_S_StR)$pi.ub, 3)`).
...
When the $\rho$ value is assumed to be 0.2, single prolonged stress had a pooled effect on biological stress response of **SMD = `r SMD_S_StR_rho0.2[["beta"]]`** (95% CI: `r SMD_S_StR_rho0.2[["ci.lb"]]` to `r SMD_S_StR_rho0.2[["ci.ub"]]`; 95% PrI: `r predict(SMD_S_StR_rho0.2)$pi.lb` to `r predict(SMD_S_StR_rho0.2)$pi.ub`).

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_StR_rho0.8 <- run_ML_SMD(df, "CvS", "Stress response", 0.8)
```

When the $\rho$ value is assumed to be 0.8, single prolonged stress had a pooled effect on biological stress response of **SMD = `r SMD_S_StR_rho0.8[["beta"]]`** (95% CI: `r SMD_S_StR_rho0.8[["ci.lb"]]` to `r SMD_S_StR_rho0.8[["ci.ub"]]`; 95% PrI: `r predict(SMD_S_StR_rho0.8)$pi.lb` to `r predict(SMD_S_StR_rho0.8)$pi.ub`).
...
Figure 2.8.1 shows the risk of bias summary for studies investigating the effect of single prolonged stress on other neurobiological outcomes in animals. The risk of bias assessment was performed using the SyRCLE RoB tool.
...
Figure 2.8.2 shows the reporting completeness summary for studies investigating the effect of single prolonged stress on other neurobiological outcomes in animals. The reporting completeness assessment was performed using the ARRIVE guidelines.
...
Single prolonged stress had a pooled effect on other neurobiological outcomes of SMD = `r round(SMD_S_OthN[['beta']], 3)` , (95% CI: `r round(SMD_S_OthN[['ci.lb']], 3)` to `r round(SMD_S_OthN[['ci.ub']], 3)`; 95% PrI: `r round(predict(SMD_S_OthN)$pi.lb, 3)` to `r round(predict(SMD_S_OthN)$pi.ub, 3)`).
...
When the $\rho$ value is assumed to be 0.2, single prolonged stress had a pooled effect on other neurobiological outcomes of **SMD = `r SMD_S_OthN_rho0.2[["beta"]]`** (95% CI: `r SMD_S_OthN_rho0.2[["ci.lb"]]` to `r SMD_S_OthN_rho0.2[["ci.ub"]]`; 95% PrI: `r predict(SMD_S_OthN_rho0.2)$pi.lb` to `r predict(SMD_S_OthN_rho0.2)$pi.ub`).

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_OthN_rho0.8 <- run_ML_SMD(df, "CvS", "Other neurobiological", 0.8)
```

When the $\rho$ value is assumed to be 0.8, single prolonged stress had a pooled effect on other neurobiological outomes of **SMD = `r SMD_S_OthN_rho0.8[["beta"]]`** (95% CI: `r SMD_S_OthN_rho0.8[["ci.lb"]]` to `r SMD_S_OthN_rho0.8[["ci.ub"]]`; 95% PrI: `r predict(SMD_S_OthN_rho0.8)$pi.lb` to `r predict(SMD_S_OthN_rho0.8)$pi.ub`).
...
![](plot_4_5.png) **4.10 Relationship between change in BDNF and change in fear memory**

![](plot_4_6.png)

**4.11 Relationship between change in BDNF and change in other behavioural outcomes**

![](plot_5_6.png) **4.12 Relationship between change in stress response and change in other behavioural outcomes**

![](plot_5_7.png)

**4.13 Relationship between change in other neurobiological outcomes and change in other behavioural outcomes**

![](plot_5_9.png) **4.14 Relationship between change in stress response and change in BDNF**

![](plot_6_7.png)

**4.15 Relationship between change in other neurobiological outcomes and change in BDNF**

![](plot_6_9.png) **4.16 Relationship between change in other neurobiological outcomes and change in stress response**
