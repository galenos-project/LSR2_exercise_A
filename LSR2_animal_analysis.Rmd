...
<<<<<<< HEAD
Exercise had a pooled effect on stress response outcomes of NMD = `r NMD_S_StR[["beta"]][1]` (95% CI: `r NMD_S_StR[["ci.lb"]]` to `r NMD_S_StR[["ci.ub"]]`) with a prediction interval of `r predict(NMD_S_StR)$pi.lb` to `r predict(NMD_S_StR)$pi.ub`). For reference the pooled effect size for SMD was `r SMD_S_StR[["SMD_ML"]][["beta"]][1]` (95% CI: `r SMD_S_StR[["SMD_ML"]][["ci.lb"]]` to `r SMD_S_StR[["SMD_ML"]][["ci.ub"]]`).
=======
Exercise had a pooled effect on stress response outcomes of NMD = `r NMD_S_Str[["beta"]][1]` (95% CI: `r NMD_S_Str[["ci.lb"]]` to `r NMD_S_Str[["ci.ub"]]`) with a prediction interval of `r predict(NMD_S_Str)$pi.lb` to `r predict(NMD_S_Str)$pi.ub`). For reference the pooled effect size for SMD was `r SMD_S_StR[["SMD_ML"]][["beta"]]` (95% CI: `r SMD_S_StR[["SMD_ML"]][["ci.lb"]]` to `r SMD_S_StR[["SMD_ML"]][["ci.ub"]]`).
>>>>>>> 19215100099575675a4aa709298c2b7b83404259
