...
Figure 2.4.4.2 displays the estimates for the pooled SMD when comparisons are stratified by whether the exercise was voluntary or forced (VoF). Whiskers indicate the 95% confidence interval of each estimate. The overall pooled SMD, not stratified by exercise type, is displayed as a diamond shape at the bottom of the plot.
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE}
forest_metafor(SMD_S_NT, "TvC", "Freezing")
```
