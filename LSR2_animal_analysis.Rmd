...
`r SMD_S_OB$SMD_ML[["k"]]` experimental comparisons were reported in `r length(unique(SMD_S_OB$data$ExperimentID_I))` experiments from `r length(unique(SMD_S_OB$data$StudyId))` publications and involving `r length(unique(SMD_S_OB$data$Strain))` different animal strain(s).
...
Exercise had a pooled effect on BDNF of SMD = `r round(SMD_S_B[["SMD_ML"]][['beta']], 3)` , (95% CI: `r round(SMD_S_B[["SMD_ML"]][['ci.lb']], 3)` to `r round(SMD_S_B[["SMD_ML"]][['ci.ub']], 3)`; 95% PrI: `r round(SMD_S_B[["pred_interval"]][["pi.lb"]], 3)` to `r round(SMD_S_B[["pred_interval"]][["pi.lb"]], 3)`).
...
When the $\rho$ value is assumed to be 0.8, exercise had a pooled effect on BDNF of **SMD = `r SMD_S_B_rho0.2[["SMD_ML"]][["beta"]]`** (95% CI: `r SMD_S_B_rho0.2[["SMD_ML"]][["ci.lb"]]` to `r SMD_S_B_rho0.2[["SMD_ML"]][["ci.ub"]]`; 95% PrI: `r round(SMD_S_B_rho0.8[["pred_interval"]][["pi.lb"]],3)` to `r round(SMD_S_B_rho0.8[["pred_interval"]][["pi.ub"]],3)`).
...
`r SMD_S_StR[["SMD_M"]][["k"]]` experimental comparisons were reported in `r length(unique(SMD_S_StR[["SMD_ML"]]$data$ExperimentID_I))` experiments from `r length(unique(SMD_S_StR[["SMD_ML"]]$data$StudyId))` publications and involving `r length(unique(SMD_S_StR[["SMD_ML"]]$data$Strain))` different animal strain(s).

|            Level            |                                               Number of categories for that level included in this analysis                                               |                                                                   Attributable variance                                                                   |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_StR[["SMD_ML"]]$s.names, SMD_S_StR[["SMD_ML"]]$s.nlevels[[which(SMD_S_StR[["SMD_ML"]]$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_StR[["SMD_ML"]]$s.names, SMD_S_StR[["SMD_ML"]]$sigma2[[which(SMD_S_StR[["SMD_ML"]]$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_StR[["SMD_ML"]]$s.names, SMD_S_StR[["SMD_ML"]]$s.nlevels[[which(SMD_S_StR[["SMD_ML"]]$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_StR[["SMD_ML"]]$s.names, SMD_S_StR[["SMD_ML"]]$sigma2[[which(SMD_S_StR[["SMD_ML"]]$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_StR[["SMD_ML"]]$s.names, SMD_S_StR[["SMD_ML"]]$s.nlevels[[which(SMD_S_StR[["SMD_ML"]]$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_StR[["SMD_ML"]]$s.names, SMD_S_StR[["SMD_ML"]]$sigma2[[which(SMD_S_StR[["SMD_ML"]]$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
...
When the $\rho$ value is assumed to be 0.2, exercise had a pooled effect on biological stress response of **SMD = `r SMD_S_StR_rho0.2[["beta"]]`** (95% CI: `r SMD_S_StR_rho0.2[["ci.lb"]]` to `r SMD_S_StR_rho0.2[["ci.ub"]]`; 95% PrI: `r round(SMD_S_StR_rho0.2[["pred_interval"]][["pi.lb"]],3)` to `r round(SMD_S_StR_rho0.2[["pred_interval"]][["pi.ub"]],3)`).

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_StR_rho0.8 <- run_ML_SMD(df, "TvC", "Stress response", 0.8)
```

When the $\rho$ value is assumed to be 0.8, exercise had a pooled effect on biological stress response of **SMD = `r SMD_S_StR_rho0.8[["beta"]]`** (95% CI: `r SMD_S_StR_rho0.8[["ci.lb"]]` to `r SMD_S_StR_rho0.8[["ci.ub"]]`; 95% PrI: `r round(SMD_S_StR_rho0.8[["pred_interval"]][["pi.lb"]],3)` to `r round(SMD_S_StR_rho0.8[["pred_interval"]][["pi.ub"]],3)`).

For reference the pooled effect size when rho is assumed to be 0.5 is `r SMD_S_StR[["SMD_M"]][["beta"]]` (95% CI: `r SMD_S_StR[["SMD_M"]][["ci.lb"]]` to `r SMD_S_StR[["SMD_M"]][["ci.ub"]]`).
...
|            Level            |                                                Number of categories for that level included in this analysis                                                 |                                                                    Attributable variance                                                                     |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_OthN[["SMD_ML"]]$s.names, SMD_S_OthN[["SMD_ML"]]$s.nlevels[[which(SMD_S_OthN[["SMD_ML"]]$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_OthN[["SMD_ML"]]$s.names, SMD_S_OthN[["SMD_ML"]]$sigma2[[which(SMD_S_OthN[["SMD_ML"]]$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_OthN[["SMD_ML"]]$s.names, SMD_S_OthN[["SMD_ML"]]$s.nlevels[[which(SMD_S_OthN[["SMD_ML"]]$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_OthN[["SMD_ML"]]$s.names, SMD_S_OthN[["SMD_ML"]]$sigma2[[which(SMD_S_OthN[["SMD_ML"]]$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OthN[["SMD_ML"]]$s.names, SMD_S_OthN[["SMD_ML"]]$s.nlevels[[which(SMD_S_OthN[["SMD_ML"]]$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OthN[["SMD_ML"]]$s.names, SMD_S_OthN[["SMD_ML"]]$sigma2[[which(SMD_S_OthN[["SMD_ML"]]$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
...
|            Level            |                                             Number of categories for that level included in this analysis                                              |                                                                 Attributable variance                                                                  |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_OB[["SMD_ML"]]$s.names, SMD_S_OB[["SMD_ML"]]$s.nlevels[[which(SMD_S_OB[["SMD_ML"]]$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_OB[["SMD_ML"]]$s.names, SMD_S_OB[["SMD_ML"]]$sigma2[[which(SMD_S_OB[["SMD_ML"]]$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_OB[["SMD_ML"]]$s.names, SMD_S_OB[["SMD_ML"]]$s.nlevels[[which(SMD_S_OB[["SMD_ML"]]$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_OB[["SMD_ML"]]$s.names, SMD_S_OB[["SMD_ML"]]$sigma2[[which(SMD_S_OB[["SMD_ML"]]$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OB[["SMD_ML"]]$s.names, SMD_S_OB[["SMD_ML"]]$s.nlevels[[which(SMD_S_OB[["SMD_ML"]]$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OB[["SMD_ML"]]$s.names, SMD_S_OB[["SMD_ML"]]$sigma2[[which(SMD_S_OB[["SMD_ML"]]$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
...
When the $\rho$ value is assumed to be 0.2, single prolonged stress had a pooled effect on other behaviours of **SMD = `r SMD_S_OB_rho0.2[["beta"]]`** (95% CI: `r SMD_S_OB_rho0.2[["ci.lb"]]` to `r SMD_S_OB_rho0.2[["ci.ub"]]`; 95% PrI: `r round(SMD_S_OB_rho0.2[["pred_interval"]][["pi.lb"]],3)` to `r round(SMD_S_OB_rho0.2[["pred_interval"]][["pi.ub"]],3)`).

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_OB_rho0.8 <- run_ML_SMD(df, "CvS", "Other behavioural", 0.8)
```

When the $\rho$ value is assumed to be 0.8, single prolonged stress had a pooled effect on other behaviours of **SMD = `r SMD_S_OB_rho0.8[["beta"]]`** (95% CI: `r SMD_S_OB_rho0.8[["ci.lb"]]` to `r SMD_S_OB_rho0.8[["ci.ub"]]`; 95% PrI: `r round(SMD_S_OB_rho0.8[["pred_interval"]][["pi.lb"]],3)` to `r round(SMD_S_OB_rho0.8[["pred_interval"]][["pi.ub"]],3)`).
...
Single prolonged stress had a pooled effect on other behaviours of SMD = `r round(SMD_S_B[["SMD_ML"]][['beta']], 3)` , (95% CI: `r round(SMD_S_B[["SMD_ML"]][['ci.lb']], 3)` to `r round(SMD_S_B[["SMD_ML"]][['ci.ub']], 3)`; 95% PrI: `r round(SMD_S_B[["pred_interval"]][["pi.lb"]], 3)` to `r round(SMD_S_B[["pred_interval"]][["pi.ub"]], 3)`).

`r SMD_S_B[["SMD_ML"]][["k"]]` experimental comparisons were reported in `r length(unique(SMD_S_B[["SMD_ML"]]$data$ExperimentID_I))` experiments from `r length(unique(SMD_S_B[["SMD_ML"]]$data$StudyId))` publications and involving `r length(unique(SMD_S_B[["SMD_ML"]]$data$Strain))` different animal strain(s).

|            Level            |                                            Number of categories for that level included in this analysis                                            |                                                                Attributable variance                                                                |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_B[["SMD_ML"]]$s.names, SMD_S_B[["SMD_ML"]]$s.nlevels[[which(SMD_S_B[["SMD_ML"]]$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_B[["SMD_ML"]]$s.names, SMD_S_B[["SMD_ML"]]$sigma2[[which(SMD_S_B[["SMD_ML"]]$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_B[["SMD_ML"]]$s.names, SMD_S_B[["SMD_ML"]]$s.nlevels[[which(SMD_S_B[["SMD_ML"]]$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_B[["SMD_ML"]]$s.names, SMD_S_B[["SMD_ML"]]$sigma2[[which(SMD_S_B[["SMD_ML"]]$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_B[["SMD_ML"]]$s.names, SMD_S_B[["SMD_ML"]]$s.nlevels[[which(SMD_S_B[["SMD_ML"]]$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_B[["SMD_ML"]]$s.names, SMD_S_B[["SMD_ML"]]$sigma2[[which(SMD_S_B[["SMD_ML"]]$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
...
When the $\rho$ value is assumed to be 0.2, single prolonged stress had a pooled effect on BDNF of **SMD = `r SMD_S_B_rho0.2[["beta"]]`** (95% CI: `r SMD_S_B_rho0.2[["ci.lb"]]` to `r SMD_S_B_rho0.2[["ci.ub"]]`; 95% PrI: `r round(SMD_S_B_rho0.2[["pred_interval"]][["pi.lb"]],3)` to `r round(SMD_S_B_rho0.2[["pred_interval"]][["pi.ub"]],3)`).

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_B_rho0.8 <- run_ML_SMD(df, "CvS", "BDNF", 0.8)
```

When the $\rho$ value is assumed to be 0.8, single prolonged stress had a pooled effect on BDNF of **SMD = `r SMD_S_B_rho0.8[["beta"]]`** (95% CI: `r SMD_S_B_rho0.8[["ci.lb"]]` to `r SMD_S_B_rho0.8[["ci.ub"]]`; 95% PrI: `r round(SMD_S_B_rho0.8[["pred_interval"]][["pi.lb"]],3)` to `r round(SMD_S_B_rho0.8[["pred_interval"]][["pi.ub"]],3)`).
...
When the $\rho$ value is assumed to be 0.2, single prolonged stress had a pooled effect on biological stress response of **SMD = `r SMD_S_StR_rho0.2[["beta"]]`** (95% CI: `r SMD_S_StR_rho0.2[["ci.lb"]]` to `r SMD_S_StR_rho0.2[["ci.ub"]]`; 95% PrI: `r round(SMD_S_StR_rho0.2[["pred_interval"]][["pi.lb"]],3)` to `r round(SMD_S_StR_rho0.2[["pred_interval"]][["pi.ub"]],3)`).

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_StR_rho0.8 <- run_ML_SMD(df, "CvS", "Stress response", 0.8)
```

When the $\rho$ value is assumed to be 0.8, single prolonged stress had a pooled effect on biological stress response of **SMD = `r SMD_S_StR_rho0.8[["beta"]]`** (95% CI: `r SMD_S_StR_rho0.8[["ci.lb"]]` to `r SMD_S_StR_rho0.8[["ci.ub"]]`; 95% PrI: `r round(SMD_S_StR_rho0.8[["pred_interval"]][["pi.lb"]],3)` to `r round(SMD_S_StR_rho0.8[["pred_interval"]][["pi.ub"]],3)`).
...
When the $\rho$ value is assumed to be 0.2, single prolonged stress had a pooled effect on other neurobiological outcomes of **SMD = `r SMD_S_OthN_rho0.2[["beta"]]`** (95% CI: `r SMD_S_OthN_rho0.2[["ci.lb"]]` to `r SMD_S_OthN_rho0.2[["ci.ub"]]`; 95% PrI: `r round(SMD_S_OthN_rho0.2[["pred_interval"]][["pi.lb"]],3)` to `r round(SMD_S_OthN_rho0.2[["pred_interval"]][["pi.ub"]],3)`).
