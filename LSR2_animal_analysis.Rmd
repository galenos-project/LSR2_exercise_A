---
title: "LSR2 analysis: Mechanisms through which exercise reduces symptom severity and/or functional impairment in posttraumatic stress disorder"
...
df_S_NT <- filter_experiment_outcome_type(df, "CvS", "Neuotransmitter levels")
...
-   Other neurobiologcal outcomes: `r length(table(df_S_OthN$StudyId))` studies and `r nrow(df_S_OthN)` comparisons in `r {strains <- unique(df_S_OthN$Strain); if (length(strains) > 1) paste(length(strains), "strains") else paste(length(strains), "strain")}`
...
Multilevel analysis is only performed if there are 5 levels or more for at least one of Strain, Study and Experiment, and that is not the case here. `r SMD_S_L[["k"]]` experimental comparisons were reported in `r length(unique(SMD_S_L$data$ExperimentID_I))` experiments from `r length(unique(SMD_S_L$data$StudyId))` publications and involving `r length(unique(SMD_S_L$data$Strain))` different animal strain(s). We provide a conventional random effects model to illustrate the data. No subgroup analysis is performed.
...
Multilevel analysis is only performed if there are 5 levels or more for at least one of Strain, Study and Experiment, and that is not the case here. `r SMD_S_FM[["k"]]` experimental comparisons were reported in `r length(unique(SMD_S_FM$data$ExperimentID_I))` experiments from `r length(unique(SMD_S_FM$data$StudyId))` publications and involving `r length(unique(SMD_S_FM$data$Strain))` different animal strain(s). We provide a conventional random effects model to illustrate the data. No subgroup analysis is performed.

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height=15}
forest_metafor(SMD_S_FM, "CvS", "Locomotor")
```
...
Multilevel analysis is only performed if there are 5 levels or more for at least one of Strain, Study and Experiment, and that is not the case here. `r SMD_S_Fr[["k"]]` experimental comparisons were reported in `r length(unique(SMD_S_Fr$data$ExperimentID_I))` experiments from `r length(unique(SMD_S_Fr$data$StudyId))` publications and involving `r length(unique(SMD_S_Fr$data$Strain))` different animal strain(s). We provide a conventional random effects model to illustrate the data. No subgroup analysis is performed.

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height=15}
forest_metafor(SMD_S_Fr, "CvS", "Freezing")
```

## 2.4 Outcome 4: Other behavioural

### 2.4.1 Risks of bias

Figure 2.4.1 shows the risk of bias summary for studies investigating the effect of single prolonged stress on sucrose preference in animals. The risk of bias assessment was performed using the SyRCLE RoB tool. 
...
Figure 2.4.2 shows the reporting completeness summary for studies investigating the effect of single prolonged stress on sucrose preference in animals. The reporting completeness assessment was performed using the ARRIVE guidelines. 
...
Single prolonged stress had a pooled effect on other behaviours of SMD = `r round(SMD_S_OB[['beta']], 3)` , (95% CI: `r round(SMD_S_OB[['ci.lb']], 3)` to `r round(SMD_S_OB[['ci.ub']], 3)` with a prediction interval of `r round(predict(SMD_S_OB)$pi.lb, 3)` to `r round(predict(SMD_S_OB)$pi.ub, 3)`. 

`r SMD_S_OB[["k"]]` experimental comparisons were reported in `r length(unique(SMD_S_OB$data$ExperimentID_I))` experiments from `r length(unique(SMD_S_OB$data$StudyId))` publications and involving `r length(unique(SMD_S_OB$data$Strain))` different animal strain(s).
...
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_OB$s.names, SMD_S_OB$s.nlevels[[which(SMD_S_OB$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_OB$s.names, SMD_S_OB$sigma2[[which(SMD_S_OB$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_OB$s.names, SMD_S_OB$s.nlevels[[which(SMD_S_OB$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_OB$s.names, SMD_S_OB$sigma2[[which(SMD_S_OB$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OB$s.names, SMD_S_OB$s.nlevels[[which(SMD_S_OB$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OB$s.names, SMD_S_OB$sigma2[[which(SMD_S_OB$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
| Study | `r ifelse('StudyId' %in% SMD_S_OB$s.names, SMD_S_OB$s.nlevels[[which(SMD_S_OB$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_OB$s.names, SMD_S_OB$sigma2[[which(SMD_S_OB$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OB$s.names, SMD_S_OB$s.nlevels[[which(SMD_S_OB$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OB$s.names, SMD_S_OB$sigma2[[which(SMD_S_OB$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_OB_sex$plotdata, "Sex", "Other behavioural","Sex","CvS")
```
...
|            Level            |                                               Number of categories for that level included in this analysis                                               |                                                                   Attributable variance                                                                   |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_OB_sex$analysis$s.names, SMD_S_OB_sex$analysis$s.nlevels[[which(SMD_S_OB_sex$analysis$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_OB_sex$analysis$s.names, SMD_S_OB_sex$analysis$sigma2[[which(SMD_S_OB_sex$analysis$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_OB_sex$analysis$s.names, SMD_S_OB_sex$analysis$s.nlevels[[which(SMD_S_OB_sex$analysis$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_OB_sex$analysis$s.names, SMD_S_OB_sex$analysis$sigma2[[which(SMD_S_OB_sex$analysis$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OB_sex$analysis$s.names, SMD_S_OB_sex$analysis$s.nlevels[[which(SMD_S_OB_sex$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OB_sex$analysis$s.names, SMD_S_OB_sex$analysis$sigma2[[which(SMD_S_OB_sex$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_OB_SyRCLERoB$plotdata, "RoBScore", "Other behavioural","SyRCLE RoB score", "CvS")
```
...
|            Level            |                                               Number of categories for that level included in this analysis                                               |                                                                   Attributable variance                                                                   |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_OB_SyRCLERoB$analysis$s.names, SMD_S_OB_SyRCLERoB$analysis$s.nlevels[[which(SMD_S_OB_SyRCLERoB$analysis$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_OB_SyRCLERoB$analysis$s.names, SMD_S_OB_SyRCLERoB$analysis$sigma2[[which(SMD_S_OB_SyRCLERoB$analysis$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_OB_SyRCLERoB$analysis$s.names, SMD_S_OB_SyRCLERoB$analysis$s.nlevels[[which(SMD_S_OB_SyRCLERoB$analysis$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_OB_SyRCLERoB$analysis$s.names, SMD_S_OB_SyRCLERoB$analysis$sigma2[[which(SMD_S_OB_SyRCLERoB$analysis$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OB_SyRCLERoB$analysis$s.names, SMD_S_OB_SyRCLERoB$analysis$s.nlevels[[which(SMD_S_OB_SyRCLERoB$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OB_SyRCLERoB$analysis$s.names, SMD_S_OB_SyRCLERoB$analysis$sigma2[[which(SMD_S_OB_SyRCLERoB$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_OB_SyRCLERoBTF$plotdata, "RoBTF", "Other behavioural","RoB score", "CvS")
```
...
|            Level            |                                               Number of categories for that level included in this analysis                                               |                                                                   Attributable variance                                                                   |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_OB_SyRCLERoBTF$analysis$s.names, SMD_S_OB_SyRCLERoBTF$analysis$s.nlevels[[which(SMD_S_OB_SyRCLERoBTF$analysis$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_OB_SyRCLERoBTF$analysis$s.names, SMD_S_OB_SyRCLERoBTF$analysis$sigma2[[which(SMD_S_OB_SyRCLERoBTF$analysis$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_OB_SyRCLERoBTF$analysis$s.names, SMD_S_OB_SyRCLERoBTF$analysis$s.nlevels[[which(SMD_S_OB_SyRCLERoBTF$analysis$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_OB_SyRCLERoBTF$analysis$s.names, SMD_S_OB_SyRCLERoBTF$analysis$sigma2[[which(SMD_S_OB_SyRCLERoBTF$analysis$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OB_SyRCLERoBTF$analysis$s.names, SMD_S_OB_SyRCLERoBTF$analysis$s.nlevels[[which(SMD_S_OB_SyRCLERoBTF$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OB_SyRCLERoBTF$analysis$s.names, SMD_S_OB_SyRCLERoBTF$analysis$sigma2[[which(SMD_S_OB_SyRCLERoBTF$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
...
| Study | `r ifelse('StudyId' %in% SMD_S_OB_ARR2$metaregression_summary$s.names, SMD_S_OB_ARR2$metaregression_summary$s.nlevels[[which(SMD_S_OB_ARR2$metaregression_summary$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_OB_ARR2$metaregression_summary$s.names, SMD_S_OB_ARR2$metaregression_summary$sigma2[[which(SMD_S_OB_ARR2$metaregression_summary$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OB_ARR2$metaregression_summary$s.names, SMD_S_OB_ARR2$metaregression_summary$s.nlevels[[which(SMD_S_OB_ARR2$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OB_ARR2$metaregression_summary$s.names, SMD_S_OB_ARR2$metaregression_summary$sigma2[[which(SMD_S_OB_ARR2$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |
...
|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|
|           Overall effect            |          \-          |      `r SMD_S_OB$beta[1]`       |                `r SMD_S_OB$ci.lb` to `r SMD_S_OB$ci.ub`                 |                         \-                         |
...
In the previous analyses for the effect of single prolonged stress on sucrose preference, we imputed a $\rho$ value - the imputed within-study correlation between observed effect sizes - of 0.5. Here, we examine the effect of imputing $\rho$ values of 0.2 and 0.8.

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_OB_rho0.2 <- run_ML_SMD(df, "CvS", "Other behavioural", 0.2)
```

When the $\rho$ value is assumed to be 0.2, single prolonged stress had a pooled effect on sucrose preference of **SMD = `r SMD_S_OB_rho0.2[["beta"]]`** (95% CI: `r SMD_S_OB_rho0.2[["ci.lb"]]` to `r SMD_S_OB_rho0.2[["ci.ub"]]`) with a prediction interval of `r predict(SMD_S_OB_rho0.2)$pi.lb` to `r predict(SMD_S_OB_rho0.2)$pi.ub`).

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_OB_rho0.8 <- run_ML_SMD(df, "CvS", "Other behavioural", 0.8)
```

When the $\rho$ value is assumed to be 0.8, single prolonged stress had a pooled effect on sucrose preference of **SMD = `r SMD_S_OB_rho0.8[["beta"]]`** (95% CI: `r SMD_S_OB_rho0.8[["ci.lb"]]` to `r SMD_S_OB_rho0.8[["ci.ub"]]`) with a prediction interval of `r predict(SMD_S_OB_rho0.8)$pi.lb` to `r predict(SMD_S_OB_rho0.8)$pi.ub`).

For reference the pooled effect size when rho is assumed to be 0.5 is `r SMD_S_OB[["beta"]]` (95% CI: `r SMD_S_OB[["ci.lb"]]` to `r SMD_S_OB[["ci.ub"]]`).
...
Figure 2.5.1 shows the risk of bias summary for studies investigating the effect of single prolonged stress on sucrose preference in animals. The risk of bias assessment was performed using the SyRCLE RoB tool. 
...
Figure 2.5.2 shows the reporting completeness summary for studies investigating the effect of single prolonged stress on sucrose preference in animals. The reporting completeness assessment was performed using the ARRIVE guidelines. 
...
The effect of single prolonged stress on other behaviours in animals using SMD as the effect size is shown in Figure 2.5.3. The pooled estimate for SMD across all individual comparisons is displayed as a diamond shape at the bottom of the plot. Dotted lines indicate the prediction interval of the pooled estimate.
...
Single prolonged stress had a pooled effect on other behaviours of SMD = `r round(SMD_S_B[['beta']], 3)` , (95% CI: `r round(SMD_S_B[['ci.lb']], 3)` to `r round(SMD_S_B[['ci.ub']], 3)` with a prediction interval of `r round(predict(SMD_S_B)$pi.lb, 3)` to `r round(predict(SMD_S_B)$pi.ub, 3)`. 

`r SMD_S_B[["k"]]` experimental comparisons were reported in `r length(unique(SMD_S_B$data$ExperimentID_I))` experiments from `r length(unique(SMD_S_B$data$StudyId))` publications and involving `r length(unique(SMD_S_B$data$Strain))` different animal strain(s).

|            Level            |                                               Number of categories for that level included in this analysis                                               |                                                                   Attributable variance                                                                   |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_B$s.names, SMD_S_B$s.nlevels[[which(SMD_S_B$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_B$s.names, SMD_S_B$sigma2[[which(SMD_S_B$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_B$s.names, SMD_S_B$s.nlevels[[which(SMD_S_B$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_B$s.names, SMD_S_B$sigma2[[which(SMD_S_B$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_B$s.names, SMD_S_B$s.nlevels[[which(SMD_S_B$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_B$s.names, SMD_S_B$sigma2[[which(SMD_S_B$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
| Study | `r ifelse('StudyId' %in% SMD_S_B$s.names, SMD_S_B$s.nlevels[[which(SMD_S_B$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_B$s.names, SMD_S_B$sigma2[[which(SMD_S_B$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_B$s.names, SMD_S_B$s.nlevels[[which(SMD_S_B$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_B$s.names, SMD_S_B$sigma2[[which(SMD_S_B$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |
...
Figure 2.5.4.1 displays the estimates for the pooled SMD's when comparisons are stratified by sex of the animal. Whiskers indicate the 95% confidence interval of each estimate. The overall pooled SMD, not stratified by sex, is displayed as a diamond shape at the bottom of the plot.
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_B_sex$plotdata, "Sex", "BDNF","Sex","CvS")
```
...
|            Level            |                                               Number of categories for that level included in this analysis                                               |                                                                   Attributable variance                                                                   |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_B_sex$analysis$s.names, SMD_S_B_sex$analysis$s.nlevels[[which(SMD_S_B_sex$analysis$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_B_sex$analysis$s.names, SMD_S_B_sex$analysis$sigma2[[which(SMD_S_B_sex$analysis$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_B_sex$analysis$s.names, SMD_S_B_sex$analysis$s.nlevels[[which(SMD_S_B_sex$analysis$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_B_sex$analysis$s.names, SMD_S_B_sex$analysis$sigma2[[which(SMD_S_B_sex$analysis$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_B_sex$analysis$s.names, SMD_S_B_sex$analysis$s.nlevels[[which(SMD_S_B_sex$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_B_sex$analysis$s.names, SMD_S_B_sex$analysis$sigma2[[which(SMD_S_B_sex$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
...
| Study | `r ifelse('StudyId' %in% SMD_S_B_ARR2$s.names, SMD_S_B_ARR2$metaregression_summary$s.nlevels[[which(SMD_S_B_ARR2$metaregression_summary$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_B_ARR2$metaregression_summary$s.names, SMD_S_B_ARR2$metaregression_summary$sigma2[[which(SMD_S_B_ARR2$metaregression_summary$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_B_ARR2$metaregression_summary$s.names, SMD_S_B_ARR2$metaregression_summary$s.nlevels[[which(SMD_S_B_ARR2$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_B_ARR2$metaregression_summary$s.names, SMD_S_B_ARR2$metaregression_summary$sigma2[[which(SMD_S_B_ARR2$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |
...
|              Moderator              |       Category       |             $\beta$              |                                  95% CI                                  |                 Marginal R^2^ (%)                  |
|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|
|           Overall effect            |          \-          |      `r SMD_S_B$beta[1]`       |                `r SMD_S_B$ci.lb` to `r SMD_S_B$ci.ub`                 |                         \-                         |
...
When the $\rho$ value is assumed to be 0.2, single prolonged stress had a pooled effect on sucrose preference of **SMD = `r SMD_S_B_rho0.2[["beta"]]`** (95% CI: `r SMD_S_B_rho0.2[["ci.lb"]]` to `r SMD_S_B_rho0.2[["ci.ub"]]`) with a prediction interval of `r predict(SMD_S_B_rho0.2)$pi.lb` to `r predict(SMD_S_B_rho0.2)$pi.ub`).

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_B_rho0.8 <- run_ML_SMD(df, "CvS", "BDNF", 0.8)
```

When the $\rho$ value is assumed to be 0.8, single prolonged stress had a pooled effect on sucrose preference of **SMD = `r SMD_S_B_rho0.8[["beta"]]`** (95% CI: `r SMD_S_B_rho0.8[["ci.lb"]]` to `r SMD_S_B_rho0.8[["ci.ub"]]`) with a prediction interval of `r predict(SMD_S_B_rho0.8)$pi.lb` to `r predict(SMD_S_B_rho0.8)$pi.ub`).

For reference the pooled effect size when rho is assumed to be 0.5 is `r SMD_S_B[["beta"]]` (95% CI: `r SMD_S_B[["ci.lb"]]` to `r SMD_S_B[["ci.ub"]]`).
...
Figure 2.6.1 shows the risk of bias summary for studies investigating the effect of single prolonged stress on sucrose preference in animals. The risk of bias assessment was performed using the SyRCLE RoB tool. 
...
Figure 2.6.2 shows the reporting completeness summary for studies investigating the effect of single prolonged stress on sucrose preference in animals. The reporting completeness assessment was performed using the ARRIVE guidelines. 
...
The effect of single prolonged stress on the biological stress response in animals using SMD as the effect size is shown in Figure 2.6.3. The pooled estimate for SMD across all individual comparisons is displayed as a diamond shape at the bottom of the plot. Dotted lines indicate the prediction interval of the pooled estimate.
...
Single prolonged stress had a pooled effect on other behaviours of SMD = `r round(SMD_S_StR[['beta']], 3)` , (95% CI: `r round(SMD_S_StR[['ci.lb']], 3)` to `r round(SMD_S_StR[['ci.ub']], 3)` with a prediction interval of `r round(predict(SMD_S_StR)$pi.lb, 3)` to `r round(predict(SMD_S_StR)$pi.ub, 3)`. 

`r SMD_S_StR[["k"]]` experimental comparisons were reported in `r length(unique(SMD_S_StR$data$ExperimentID_I))` experiments from `r length(unique(SMD_S_StR$data$StudyId))` publications and involving `r length(unique(SMD_S_StR$data$Strain))` different animal strain(s).

|            Level            |                                               Number of categories for that level included in this analysis                                               |                                                                   Attributable variance                                                                   |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_StR$s.names, SMD_S_StR$s.nlevels[[which(SMD_S_StR$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_StR$s.names, SMD_S_StR$sigma2[[which(SMD_S_StR$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_StR$s.names, SMD_S_StR$s.nlevels[[which(SMD_S_StR$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_StR$s.names, SMD_S_StR$sigma2[[which(SMD_S_StR$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_StR$s.names, SMD_S_StR$s.nlevels[[which(SMD_S_StR$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_StR$s.names, SMD_S_StR$sigma2[[which(SMD_S_StR$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
| Study | `r ifelse('StudyId' %in% SMD_S_StR$s.names, SMD_S_StR$s.nlevels[[which(SMD_S_StR$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_StR$s.names, SMD_S_StR$sigma2[[which(SMD_S_StR$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_StR$s.names, SMD_S_StR$s.nlevels[[which(SMD_S_StR$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_StR$s.names, SMD_S_StR$sigma2[[which(SMD_S_StR$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |
...
Figure 2.6.4.1 displays the estimates for the pooled SMD's when comparisons are stratified by sex of the animal. Whiskers indicate the 95% confidence interval of each estimate. The overall pooled SMD, not stratified by sex, is displayed as a diamond shape at the bottom of the plot.
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_StR_sex$plotdata, "Sex", "Stress response","Sex","CvS")
```
...
|            Level            |                                               Number of categories for that level included in this analysis                                               |                                                                   Attributable variance                                                                   |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_StR_sex$analysis$s.names, SMD_S_StR_sex$analysis$s.nlevels[[which(SMD_S_StR_sex$analysis$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_StR_sex$analysis$s.names, SMD_S_StR_sex$analysis$sigma2[[which(SMD_S_StR_sex$analysis$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_StR_sex$analysis$s.names, SMD_S_StR_sex$analysis$s.nlevels[[which(SMD_S_StR_sex$analysis$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_StR_sex$analysis$s.names, SMD_S_StR_sex$analysis$sigma2[[which(SMD_S_StR_sex$analysis$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_StR_sex$analysis$s.names, SMD_S_StR_sex$analysis$s.nlevels[[which(SMD_S_StR_sex$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_StR_sex$analysis$s.names, SMD_S_StR_sex$analysis$sigma2[[which(SMD_S_StR_sex$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
...
Figure 2.6.4.3 displays the estimates for the pooled SMD's when comparisons are stratified by how many of the SyRCLE risk of bias assessment criteria (of which there are 10) that the experiment met. Whiskers indicate the 95% confidence interval of each estimate. The overall pooled SMD, not stratified by SyRCLE Risk of Bias, is displayed as a diamond shape at the bottom of the plot.
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_StR_SyRCLERoB$plotdata, "RoBScore", "Stress response","SyRCLE RoB score", "CvS")
```
...
|            Level            |                                               Number of categories for that level included in this analysis                                               |                                                                   Attributable variance                                                                   |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_StR_SyRCLERoB$analysis$s.names, SMD_S_StR_SyRCLERoB$analysis$s.nlevels[[which(SMD_S_StR_SyRCLERoB$analysis$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_StR_SyRCLERoB$analysis$s.names, SMD_S_StR_SyRCLERoB$analysis$sigma2[[which(SMD_S_StR_SyRCLERoB$analysis$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_StR_SyRCLERoB$analysis$s.names, SMD_S_StR_SyRCLERoB$analysis$s.nlevels[[which(SMD_S_StR_SyRCLERoB$analysis$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_StR_SyRCLERoB$analysis$s.names, SMD_S_StR_SyRCLERoB$analysis$sigma2[[which(SMD_S_StR_SyRCLERoB$analysis$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_StR_SyRCLERoB$analysis$s.names, SMD_S_StR_SyRCLERoB$analysis$s.nlevels[[which(SMD_S_StR_SyRCLERoB$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_StR_SyRCLERoB$analysis$s.names, SMD_S_StR_SyRCLERoB$analysis$sigma2[[which(SMD_S_StR_SyRCLERoB$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
...
Figure 2.6.4.4 displays the estimates for the pooled SMD's when comparisons are stratified by whether of not any of the SyRCLE Risk of bias domains were rated as low risk of bias. Whiskers indicate the 95% confidence interval of each estimate. The overall pooled SMD, not stratified by SyRCLE Risk of Bias, is displayed as a diamond shape at the bottom of the plot.
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_StR_SyRCLERoBTF$plotdata, "RoBTF", "Stress response","RoB score", "CvS")
```
...
|            Level            |                                               Number of categories for that level included in this analysis                                               |                                                                   Attributable variance                                                                   |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_StR_SyRCLERoBTF$analysis$s.names, SMD_S_StR_SyRCLERoBTF$analysis$s.nlevels[[which(SMD_S_StR_SyRCLERoBTF$analysis$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_StR_SyRCLERoBTF$analysis$s.names, SMD_S_StR_SyRCLERoBTF$analysis$sigma2[[which(SMD_S_StR_SyRCLERoBTF$analysis$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_StR_SyRCLERoBTF$analysis$s.names, SMD_S_StR_SyRCLERoBTF$analysis$s.nlevels[[which(SMD_S_StR_SyRCLERoBTF$analysis$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_StR_SyRCLERoBTF$analysis$s.names, SMD_S_StR_SyRCLERoBTF$analysis$sigma2[[which(SMD_S_StR_SyRCLERoBTF$analysis$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_StR_SyRCLERoBTF$analysis$s.names, SMD_S_StR_SyRCLERoBTF$analysis$s.nlevels[[which(SMD_S_StR_SyRCLERoBTF$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_StR_SyRCLERoBTF$analysis$s.names, SMD_S_StR_SyRCLERoBTF$analysis$sigma2[[which(SMD_S_StR_SyRCLERoBTF$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
...
| Study | `r ifelse('StudyId' %in% SMD_S_StR_ARR2$metaregression_summary$s.names, SMD_S_StR_ARR2$metaregression_summary$s.nlevels[[which(SMD_S_StR_ARR2$metaregression_summary$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_StR_ARR2$metaregression_summary$s.names, SMD_S_StR_ARR2$metaregression_summary$sigma2[[which(SMD_S_StR_ARR2$metaregression_summary$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_StR_ARR2$metaregression_summary$s.names, SMD_S_StR_ARR2$metaregression_summary$s.nlevels[[which(SMD_S_StR_ARR2$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_StR_ARR2$metaregression_summary$s.names, SMD_S_StR_ARR2$metaregression_summary$sigma2[[which(SMD_S_StR_ARR2$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |
...
|              Moderator              |       Category       |             $\beta$              |                                  95% CI                                  |                 Marginal R^2^ (%)                  |
|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|
|           Overall effect            |          \-          |      `r SMD_S_StR$beta[1]`       |                `r SMD_S_StR$ci.lb` to `r SMD_S_StR$ci.ub`                 |                         \-                         |
...
When the $\rho$ value is assumed to be 0.2, single prolonged stress had a pooled effect on sucrose preference of **SMD = `r SMD_S_StR_rho0.2[["beta"]]`** (95% CI: `r SMD_S_StR_rho0.2[["ci.lb"]]` to `r SMD_S_StR_rho0.2[["ci.ub"]]`) with a prediction interval of `r predict(SMD_S_StR_rho0.2)$pi.lb` to `r predict(SMD_S_StR_rho0.2)$pi.ub`).

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_StR_rho0.8 <- run_ML_SMD(df, "CvS", "Stress response", 0.8)
```

When the $\rho$ value is assumed to be 0.8, single prolonged stress had a pooled effect on sucrose preference of **SMD = `r SMD_S_StR_rho0.8[["beta"]]`** (95% CI: `r SMD_S_StR_rho0.8[["ci.lb"]]` to `r SMD_S_StR_rho0.8[["ci.ub"]]`) with a prediction interval of `r predict(SMD_S_StR_rho0.8)$pi.lb` to `r predict(SMD_S_StR_rho0.8)$pi.ub`).

For reference the pooled effect size when rho is assumed to be 0.5 is `r SMD_S_StR[["beta"]]` (95% CI: `r SMD_S_StR[["ci.lb"]]` to `r SMD_S_StR[["ci.ub"]]`).
...
## 2.8 Outcome 8: Other neurobiological

### 2.8.1 Risks of bias

Figure 2.8.1 shows the risk of bias summary for studies investigating the effect of single prolonged stress on other neurobiological outomes in animals. The risk of bias assessment was performed using the SyRCLE RoB tool. 
...
Figure 2.8.2 shows the reporting completeness summary for studies investigating the effect of single prolonged stress on other neurobiological outomes in animals. The reporting completeness assessment was performed using the ARRIVE guidelines. 
...
The effect of single prolonged stress on other neurobiological outcomes in animals using SMD as the effect size is shown in Figure 2.1.3. The pooled estimate for SMD across all individual comparisons is displayed as a diamond shape at the bottom of the plot. Dotted lines indicate the prediction interval of the pooled estimate.
...
Single prolonged stress had a pooled effect on other behaviours of SMD = `r round(SMD_S_OthN[['beta']], 3)` , (95% CI: `r round(SMD_S_OthN[['ci.lb']], 3)` to `r round(SMD_S_OthN[['ci.ub']], 3)` with a prediction interval of `r round(predict(SMD_S_OthN)$pi.lb, 3)` to `r round(predict(SMD_S_OthN)$pi.ub, 3)`. 

`r SMD_S_OthN[["k"]]` experimental comparisons were reported in `r length(unique(SMD_S_OthN$data$ExperimentID_I))` experiments from `r length(unique(SMD_S_OthN$data$StudyId))` publications and involving `r length(unique(SMD_S_OthN$data$Strain))` different animal strain(s).

|            Level            |                                               Number of categories for that level included in this analysis                                               |                                                                   Attributable variance                                                                   |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_OthN$s.names, SMD_S_OthN$s.nlevels[[which(SMD_S_OthN$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_OthN$s.names, SMD_S_OthN$sigma2[[which(SMD_S_OthN$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_OthN$s.names, SMD_S_OthN$s.nlevels[[which(SMD_S_OthN$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_OthN$s.names, SMD_S_OthN$sigma2[[which(SMD_S_OthN$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OthN$s.names, SMD_S_OthN$s.nlevels[[which(SMD_S_OthN$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OthN$s.names, SMD_S_OthN$sigma2[[which(SMD_S_OthN$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
| Study | `r ifelse('StudyId' %in% SMD_S_OthN$s.names, SMD_S_OthN$s.nlevels[[which(SMD_S_OthN$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_OthN$s.names, SMD_S_OthN$sigma2[[which(SMD_S_OthN$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OthN$s.names, SMD_S_OthN$s.nlevels[[which(SMD_S_OthN$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OthN$s.names, SMD_S_OthN$sigma2[[which(SMD_S_OthN$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |
...
Figure 2.8.4.1 displays the estimates for the pooled SMD's when comparisons are stratified by sex of the animal. Whiskers indicate the 95% confidence interval of each estimate. The overall pooled SMD, not stratified by sex, is displayed as a diamond shape at the bottom of the plot.
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_OthN_sex$plotdata, "Sex", "Other neurobiological","Sex","CvS")
```
...
|            Level            |                                               Number of categories for that level included in this analysis                                               |                                                                   Attributable variance                                                                   |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_OthN_sex$analysis$s.names, SMD_S_OthN_sex$analysis$s.nlevels[[which(SMD_S_OthN_sex$analysis$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_OthN_sex$analysis$s.names, SMD_S_OthN_sex$analysis$sigma2[[which(SMD_S_OthN_sex$analysis$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_OthN_sex$analysis$s.names, SMD_S_OthN_sex$analysis$s.nlevels[[which(SMD_S_OthN_sex$analysis$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_OthN_sex$analysis$s.names, SMD_S_OthN_sex$analysis$sigma2[[which(SMD_S_OthN_sex$analysis$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OthN_sex$analysis$s.names, SMD_S_OthN_sex$analysis$s.nlevels[[which(SMD_S_OthN_sex$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OthN_sex$analysis$s.names, SMD_S_OthN_sex$analysis$sigma2[[which(SMD_S_OthN_sex$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
...
| Study | `r ifelse('StudyId' %in% SMD_S_OthN_ARR2$metaregression_summary$s.names, SMD_S_OthN_ARR2$metaregression_summary$s.nlevels[[which(SMD_S_OthN_ARR2$metaregression_summary$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_OthN_ARR2$metaregression_summary$s.names, SMD_S_OthN_ARR2$metaregression_summary$sigma2[[which(SMD_S_OthN_ARR2$metaregression_summary$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OthN_ARR2$metaregression_summary$s.names, SMD_S_OthN_ARR2$metaregression_summary$s.nlevels[[which(SMD_S_OthN_ARR2$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OthN_ARR2$metaregression_summary$s.names, SMD_S_OthN_ARR2$metaregression_summary$sigma2[[which(SMD_S_OthN_ARR2$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |


#### **Heterogeneity explained by covariates (Effect of modelling on other neurobiological outomes)**
...
SMD_S_OthN_ARRIVEI <- subgroup_SMDI(df, "CvS", "Other neurobiological", "ARRIVEScoreCat", 0.5)
```

The table below shows which of the covariates, if any, explain some of the heterogeneity observed in the effect sizes of the effect of TAAR1 agonists on other neurobiological outomes. We present marginal R^2^, which measures the proportion of variance explained by including moderators in the model (the % change in the between-studies variance when the covariate is included in the model, in other words the % of the heterogeneity explained by the variable). The co-efficients are derived form an RMA model fitted with an intercept (and so represent, for each category, the point estimate and 95% CIs of the effect in that category).


|              Moderator              |       Category       |             $\beta$              |                                  95% CI                                  |                 Marginal R^2^ (%)                  |
|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|
|           Overall effect            |          \-          |      `r SMD_S_OthN$beta[1]`       |                `r SMD_S_OthN$ci.lb` to `r SMD_S_OthN$ci.ub`                 |                         \-                         |
...
In the previous analyses for the effect of single prolonged stress on other neurobiological outomes, we imputed a $\rho$ value - the imputed within-study correlation between observed effect sizes - of 0.5. Here, we examine the effect of imputing $\rho$ values of 0.2 and 0.8.

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_OthN_rho0.2 <- run_ML_SMD(df, "CvS", "Other neurobiological", 0.2)
```

When the $\rho$ value is assumed to be 0.2, single prolonged stress had a pooled effect on other neurobiological outomes of **SMD = `r SMD_S_OthN_rho0.2[["beta"]]`** (95% CI: `r SMD_S_OthN_rho0.2[["ci.lb"]]` to `r SMD_S_OthN_rho0.2[["ci.ub"]]`) with a prediction interval of `r predict(SMD_S_OthN_rho0.2)$pi.lb` to `r predict(SMD_S_OthN_rho0.2)$pi.ub`).

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_OthN_rho0.8 <- run_ML_SMD(df, "CvS", "Other neurobiological", 0.8)
```

When the $\rho$ value is assumed to be 0.8, single prolonged stress had a pooled effect on other neurobiological outomes of **SMD = `r SMD_S_OthN_rho0.8[["beta"]]`** (95% CI: `r SMD_S_OthN_rho0.8[["ci.lb"]]` to `r SMD_S_OthN_rho0.8[["ci.ub"]]`) with a prediction interval of `r predict(SMD_S_OthN_rho0.8)$pi.lb` to `r predict(SMD_S_OthN_rho0.8)$pi.ub`).

For reference the pooled effect size when rho is assumed to be 0.5 is `r SMD_S_OthN[["beta"]]` (95% CI: `r SMD_S_OthN[["ci.lb"]]` to `r SMD_S_OthN[["ci.ub"]]`).
...
df_S_NT <- filter_experiment_outcome_type(df, "TvC", "Neuotransmitter levels")
...
`r length(table(df_S$StudyId))` studies (`r nrow(df%>%filter(SortLabel == "TvC"))` comparisons) investigated the effects of model induction. The number of studies and individual effect sizes for each outcome were:
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height=15}
forest_metafor(SMD_S_FM, "TvC", "Locomotor")
```
...
## 3.4 Outcome 4: Other behavioural

### 3.4.1 Risks of bias

Figure 3.4.1 shows the risk of bias summary for studies investigating the effect of single prolonged stress on sucrose preference in animals. The risk of bias assessment was performed using the SyRCLE RoB tool. 
...
The effect of single prolonged stress on other bevaiours in animals using SMD as the effect size is shown in Figure 3.4.3. The pooled estimate for SMD across all individual comparisons is displayed as a diamond shape at the bottom of the plot. Dotted lines indicate the prediction interval of the pooled estimate.
...
Exercise interventions had a pooled effect on other behaviours induced by single prolonged stress of SMD = `r round(SMD_S_OB[['beta']], 3)` , (95% CI: `r round(SMD_S_OB[['ci.lb']], 3)` to `r round(SMD_S_OB[['ci.ub']], 3)` with a prediction interval of `r round(predict(SMD_S_OB)$pi.lb, 3)` to `r round(predict(SMD_S_OB)$pi.ub, 3)`. 
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_OB_sex$plotdata, "Sex", "Other behavioural","Sex","TvC")
```
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_OB_VoF$plotdata, "VoF", "Other behavioural","VoF","TvC")
```
...
|            Level            |                                               Number of categories for that level included in this analysis                                               |                                                                   Attributable variance                                                                   |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_OB_VoF$analysis$s.names, SMD_S_OB_VoF$analysis$s.nlevels[[which(SMD_S_OB_VoF$analysis$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_OB_VoF$analysis$s.names, SMD_S_OB_VoF$analysis$sigma2[[which(SMD_S_OB_VoF$analysis$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_OB_VoF$analysis$s.names, SMD_S_OB_VoF$analysis$s.nlevels[[which(SMD_S_OB_VoF$analysis$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_OB_VoF$analysis$s.names, SMD_S_OB_VoF$analysis$sigma2[[which(SMD_S_OB_VoF$analysis$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OB_VoF$analysis$s.names, SMD_S_OB_VoF$analysis$s.nlevels[[which(SMD_S_OB_VoF$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OB_VoF$analysis$s.names, SMD_S_OB_VoF$analysis$sigma2[[which(SMD_S_OB_VoF$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
...
We provide a metaregression of the number of weeks of treatment as a continuous variable.
...
| Study | `r ifelse('StudyId' %in% SMD_S_OB_DOE$metaregression_summary$s.names, SMD_S_OB_DOE$metaregression_summary$s.nlevels[[which(SMD_S_OB_DOE$metaregression_summary$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_OB_DOE$metaregression_summary$s.names, SMD_S_OB_DOE$metaregression_summary$sigma2[[which(SMD_S_OB_DOE$metaregression_summary$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OB_DOE$metaregression_summary$s.names, SMD_S_OB_DOE$metaregression_summary$s.nlevels[[which(SMD_S_OB_DOE$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OB_DOE$metaregression_summary$s.names, SMD_S_OB_DOE$metaregression_summary$sigma2[[which(SMD_S_OB_DOE$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |

#### **Exercise Intensity**

We provide a metaregression where exercise intensity is considered as a continuous variable.
...
The p-value for the association between exercise intensity and outcome reported was `r  round(SMD_S_OB_EI$metaregression_summary$pval[2],3)`).
...
| Study | `r ifelse('StudyId' %in% SMD_S_OB_EI$metaregression_summary$s.names, SMD_S_OB_EI$metaregression_summary$s.nlevels[[which(SMD_S_OB_EI$metaregression_summary$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_OB_EI$metaregression_summary$s.names, SMD_S_OB_EI$metaregression_summary$sigma2[[which(SMD_S_OB_EI$metaregression_summary$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OB_EI$metaregression_summary$s.names, SMD_S_OB_EI$metaregression_summary$s.nlevels[[which(SMD_S_OB_EI$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OB_EI$metaregression_summary$s.names, SMD_S_OB_EI$metaregression_summary$sigma2[[which(SMD_S_OB_EI$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |

#### **Total exercise**

We provide a metaregression where the total exercise as the product of the number of sessions, session duration and session intensity, expressed in km, is considered as a continuous variable.
...
The p-value for the association between total exercise and outcome reported was `r ifelse(SMD_S_OB_TE$metaregression_summary$pval[2] < 0.001, "<0.001", sprintf("%.3f", SMD_S_OB_TE$metaregression_summary$pval[2]))`
...
| Study | `r ifelse('StudyId' %in% SMD_S_OB_TE$metaregression_summary$s.names, SMD_S_OB_TE$metaregression_summary$s.nlevels[[which(SMD_S_OB_TE$metaregression_summary$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_OB_TE$metaregression_summary$s.names, SMD_S_OB_TE$metaregression_summary$sigma2[[which(SMD_S_OB_TE$metaregression_summary$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OB_TE$metaregression_summary$s.names, SMD_S_OB_TE$metaregression_summary$s.nlevels[[which(SMD_S_OB_TE$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OB_TE$metaregression_summary$s.names, SMD_S_OB_TE$metaregression_summary$sigma2[[which(SMD_S_OB_TE$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |

#### **SyRCLE RoB assessment considered as a categorical variable**

Figure 3.4.4.6 displays the estimates for the pooled SMD's when comparisons are stratified by how many of the SyRCLE risk of bias assessment criteria (of which there are 10) that the experiment met. Whiskers indicate the 95% confidence interval of each estimate. The overall pooled SMD, not stratified by SyRCLE Risk of Bias, is displayed as a diamond shape at the bottom of the plot.
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_OB_SyRCLERoB$plotdata, "RoBScore", "Other behavioural","SyRCLE RoB score", "TvC")
```
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_OB_SyRCLERoBTF$plotdata, "RoBTF", "Other behavioural","RoB score", "TvC")
```
...
The effect of single prolonged stress on other bevaiours in animals using SMD as the effect size is shown in Figure 3.5.3. The pooled estimate for SMD across all individual comparisons is displayed as a diamond shape at the bottom of the plot. Dotted lines indicate the prediction interval of the pooled estimate.
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_B_sex$plotdata, "Sex", "BDNF","Sex","TvC")
```
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_B_VoF$plotdata, "VoF", "BDNF","VoF","TvC")
```
...
|            Level            |                                               Number of categories for that level included in this analysis                                               |                                                                   Attributable variance                                                                   |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_B_VoF$analysis$s.names, SMD_S_B_VoF$analysis$s.nlevels[[which(SMD_S_B_VoF$analysis$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_B_VoF$analysis$s.names, SMD_S_B_VoF$analysis$sigma2[[which(SMD_S_B_VoF$analysis$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_B_VoF$analysis$s.names, SMD_S_B_VoF$analysis$s.nlevels[[which(SMD_S_B_VoF$analysis$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_B_VoF$analysis$s.names, SMD_S_B_VoF$analysis$sigma2[[which(SMD_S_B_VoF$analysis$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_B_VoF$analysis$s.names, SMD_S_B_VoF$analysis$s.nlevels[[which(SMD_S_B_VoF$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_B_VoF$analysis$s.names, SMD_S_B_VoF$analysis$sigma2[[which(SMD_S_B_VoF$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
...
| Study | `r ifelse('StudyId' %in% SMD_S_B_DOE$metaregression_summary$s.names, SMD_S_B_DOE$metaregression_summary$s.nlevels[[which(SMD_S_B_DOE$metaregression_summary$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_B_DOE$metaregression_summary$s.names, SMD_S_B_DOE$metaregression_summary$sigma2[[which(SMD_S_B_DOE$metaregression_summary$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_B_DOE$metaregression_summary$s.names, SMD_S_B_DOE$metaregression_summary$s.nlevels[[which(SMD_S_B_DOE$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_B_DOE$metaregression_summary$s.names, SMD_S_B_DOE$metaregression_summary$sigma2[[which(SMD_S_B_DOE$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |
...
| Study | `r ifelse('StudyId' %in% SMD_S_B_EI$metaregression_summary$s.names, SMD_S_B_EI$metaregression_summary$s.nlevels[[which(SMD_S_B_EI$metaregression_summary$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_B_EI$metaregression_summary$s.names, SMD_S_B_EI$metaregression_summary$sigma2[[which(SMD_S_B_EI$metaregression_summary$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_B_EI$metaregression_summary$s.names, SMD_S_B_EI$metaregression_summary$s.nlevels[[which(SMD_S_B_EI$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_B_EI$metaregression_summary$s.names, SMD_S_B_EI$metaregression_summary$sigma2[[which(SMD_S_B_EI$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |
...
| Study | `r ifelse('StudyId' %in% SMD_S_B_TE$metaregression_summary$s.names, SMD_S_B_TE$metaregression_summary$s.nlevels[[which(SMD_S_B_TE$metaregression_summary$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_B_TE$metaregression_summary$s.names, SMD_S_B_TE$metaregression_summary$sigma2[[which(SMD_S_B_TE$metaregression_summary$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_B_TE$metaregression_summary$s.names, SMD_S_B_TE$metaregression_summary$s.nlevels[[which(SMD_S_B_TE$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_B_TE$metaregression_summary$s.names, SMD_S_B_TE$metaregression_summary$sigma2[[which(SMD_S_B_TE$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |
...
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_B_ARR2$metaregression_summary$s.names, SMD_S_B_ARR2$metaregression_summary$s.nlevels[[which(SMD_S_B_ARR2$metaregression_summary$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_B_ARR2$metaregression_summary$s.names, SMD_S_B_ARR2$metaregression_summary$sigma2[[which(SMD_S_B_ARR2$metaregression_summary$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_B_ARR2$metaregression_summary$s.names, SMD_S_B_ARR2$metaregression_summary$s.nlevels[[which(SMD_S_B_ARR2$metaregression_summary$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_B_ARR2$metaregression_summary$s.names, SMD_S_B_ARR2$metaregression_summary$sigma2[[which(SMD_S_B_ARR2$metaregression_summary$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
| Study | `r ifelse('StudyId' %in% SMD_S_B_ARR2$metaregression_summary$s.names, SMD_S_B_ARR2$metaregression_summary$s.nlevels[[which(SMD_S_B_ARR2$metaregression_summary$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_B_ARR2$metaregression_summary$s.names, SMD_S_B_ARR2$metaregression_summary$sigma2[[which(SMD_S_B_ARR2$metaregression_summary$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_B_ARR2$metaregression_summary$s.names, SMD_S_B_ARR2$metaregression_summary$s.nlevels[[which(SMD_S_B_ARR2$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_B_ARR2$metaregression_summary$s.names, SMD_S_B_ARR2$metaregression_summary$sigma2[[which(SMD_S_B_ARR2$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |
...
Figure 3.6.1 shows the risk of bias summary for studies investigating the effect of single prolonged stress on sucrose preference in animals. The risk of bias assessment was performed using the SyRCLE RoB tool. 
...
Figure 3.6.2 shows the reporting completeness summary for studies investigating the effect of single prolonged stress on sucrose preference in animals. The reporting completeness assessment was performed using the ARRIVE guidelines. 
...
Exercise interventions had a pooled effect on other behaviours induced by single prolonged stress of SMD = `r round(SMD_S_StR[['beta']], 3)` , (95% CI: `r round(SMD_S_StR[['ci.lb']], 3)` to `r round(SMD_S_StR[['ci.ub']], 3)` with a prediction interval of `r round(predict(SMD_S_StR)$pi.lb, 3)` to `r round(predict(SMD_S_StR)$pi.ub, 3)`. 
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_StR_sex$plotdata, "Sex", "Stress response","Sex","TvC")
```
...
The p-value for the association between duration of treatment and outcome reported was `r  round(SMD_S_StR_DOE$metaregression_summary$pval[2],3)`).
...
| Study | `r ifelse('StudyId' %in% SMD_S_StR_DOE$metaregression_summary$s.names, SMD_S_StR_DOE$metaregression_summary$s.nlevels[[which(SMD_S_StR_DOE$metaregression_summary$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_StR_DOE$metaregression_summary$s.names, SMD_S_StR_DOE$metaregression_summary$sigma2[[which(SMD_S_StR_DOE$metaregression_summary$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_StR_DOE$metaregression_summary$s.names, SMD_S_StR_DOE$metaregression_summary$s.nlevels[[which(SMD_S_StR_DOE$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_StR_DOE$metaregression_summary$s.names, SMD_S_StR_DOE$metaregression_summary$sigma2[[which(SMD_S_StR_DOE$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |
...
The p-value for the association between exercise intensity and outcome reported was `r  round(SMD_S_StR_EI$metaregression_summary$pval[2],3)`).
...
| Study | `r ifelse('StudyId' %in% SMD_S_StR_EI$metaregression_summary$s.names, SMD_S_StR_EI$metaregression_summary$s.nlevels[[which(SMD_S_StR_EI$metaregression_summary$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_StR_EI$metaregression_summary$s.names, SMD_S_StR_EI$metaregression_summary$sigma2[[which(SMD_S_StR_EI$metaregression_summary$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_StR_EI$metaregression_summary$s.names, SMD_S_StR_EI$metaregression_summary$s.nlevels[[which(SMD_S_StR_EI$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_StR_EI$metaregression_summary$s.names, SMD_S_StR_EI$metaregression_summary$sigma2[[which(SMD_S_StR_EI$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |
...
The p-value for the association between total exercise and outcome reported was `r ifelse(SMD_S_StR_TE$metaregression_summary$pval[2] < 0.001, "<0.001", sprintf("%.3f", SMD_S_StR_TE$metaregression_summary$pval[2]))`
...
| Study | `r ifelse('StudyId' %in% SMD_S_StR_TE$metaregression_summary$s.names, SMD_S_StR_TE$metaregression_summary$s.nlevels[[which(SMD_S_StR_TE$metaregression_summary$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_StR_TE$metaregression_summary$s.names, SMD_S_StR_TE$metaregression_summary$sigma2[[which(SMD_S_StR_TE$metaregression_summary$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_StR_TE$metaregression_summary$s.names, SMD_S_StR_TE$metaregression_summary$s.nlevels[[which(SMD_S_StR_TE$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_StR_TE$metaregression_summary$s.names, SMD_S_StR_TE$metaregression_summary$sigma2[[which(SMD_S_StR_TE$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_StR_SyRCLERoB$plotdata, "RoBScore", "Stress response","SyRCLE RoB score", "TvC")
```
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_StR_SyRCLERoBTF$plotdata, "RoBTF", "Stress response","RoB score", "TvC")
```
...
|                 \-                  |       *Female*       |    `r SMD_S_StR_sexI$beta[1]`    |        `r SMD_S_StR_sexI$ci.lb[1]` to `r SMD_S_StR_sexI$ci.ub[1]`         |                         \-                         |
|                 \-                  |        *Male*        |    `r SMD_S_StR_sexI$beta[2]`    |        `r SMD_S_StR_sexI$ci.lb[2]` to `r SMD_S_StR_sexI$ci.ub[2]`         |                         \-                         |
|                 \-                  |        *Voluntary*        |    `r SMD_S_StR_VoFI$beta[2]`    |        `r SMD_S_StR_VoFI$ci.lb[2]` to `r SMD_S_StR_VoFI$ci.ub[2]`         |                         \-                         |
...
When the $\rho$ value is assumed to be 0.2, single prolonged stress had a pooled effect on other neurobiological outomes of **SMD = `r SMD_S_StR_rho0.2[["beta"]]`** (95% CI: `r SMD_S_StR_rho0.2[["ci.lb"]]` to `r SMD_S_StR_rho0.2[["ci.ub"]]`) with a prediction interval of `r predict(SMD_S_StR_rho0.2)$pi.lb` to `r predict(SMD_S_StR_rho0.2)$pi.ub`).

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_StR_rho0.8 <- run_ML_SMD(df, "TvC", "Stress response", 0.8)
```

When the $\rho$ value is assumed to be 0.8, single prolonged stress had a pooled effect on other neurobiological outomes of **SMD = `r SMD_S_StR_rho0.8[["beta"]]`** (95% CI: `r SMD_S_StR_rho0.8[["ci.lb"]]` to `r SMD_S_StR_rho0.8[["ci.ub"]]`) with a prediction interval of `r predict(SMD_S_StR_rho0.8)$pi.lb` to `r predict(SMD_S_StR_rho0.8)$pi.ub`).
...
Egger regression based on `r run_sse_SMD_L(df, 'TvC', 'Stress response')[["k"]]` studies of modelling of depression where other neurobiological outomes was measured showed a coefficient for a small study effect of `r run_sse_SMD_L(df, 'TvC', 'Stress response')[["beta"]][2]` (95% CI: `r run_sse_SMD_L(df, 'TvC', 'Stress response')[["ci.lb"]][2]` to `r run_sse_SMD_L(df, 'TvC', 'Stress response')[["ci.ub"]][2]`; p = `r ifelse(run_sse_SMD_L(df, 'TvC', 'Stress response')[["pval"]][2] < 0.001, "<0.001", sprintf("%.3f", run_sse_SMD_L(df, 'TvC', 'Stress response')[["pval"]][2]))`).

## 3.7 Outcome 8: Neurotransmitter levels

No outcomes were presented

## 3.8 Outcome 9: Other neurobiological

### 3.8.1 Risks of bias

Figure 3.8.1 shows the risk of bias summary for studies investigating the effect of single prolonged stress on other neurobiological outomes in animals. The risk of bias assessment was performed using the SyRCLE RoB tool. 
...
Figure 3.8.2 shows the reporting completeness summary for studies investigating the effect of single prolonged stress on other neurobiological outomes in animals. The reporting completeness assessment was performed using the ARRIVE guidelines. 
...
Figure 3.8.4.1 displays the estimates for the pooled SMD's when comparisons are stratified by sex of the animal. Whiskers indicate the 95% confidence interval of each estimate. The overall pooled SMD, not stratified by sex, is displayed as a diamond shape at the bottom of the plot.
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_OthN_sex$plotdata, "Sex", "Other neurobiological","Sex","TvC")
```
...
The p-value for the association between the sex of animal groups used and outcome reported was `r round(SMD_S_OthN_sex_noI$QMp,3)`.
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
forest_subgroup(SMD_S_OthN_VoF$plotdata, "VoF", "Other neurobiological","VoF","TvC")
```
...
The p-value for the association between the VoF of animal groups used and outcome reported was `r round(SMD_S_OthN_VoF_noI$QMp,3)`.

|            Level            |                                               Number of categories for that level included in this analysis                                               |                                                                   Attributable variance                                                                   |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_OthN_VoF$analysis$s.names, SMD_S_OthN_VoF$analysis$s.nlevels[[which(SMD_S_OthN_VoF$analysis$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_OthN_VoF$analysis$s.names, SMD_S_OthN_VoF$analysis$sigma2[[which(SMD_S_OthN_VoF$analysis$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_OthN_VoF$analysis$s.names, SMD_S_OthN_VoF$analysis$s.nlevels[[which(SMD_S_OthN_VoF$analysis$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_OthN_VoF$analysis$s.names, SMD_S_OthN_VoF$analysis$sigma2[[which(SMD_S_OthN_VoF$analysis$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OthN_VoF$analysis$s.names, SMD_S_OthN_VoF$analysis$s.nlevels[[which(SMD_S_OthN_VoF$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_OthN_VoF$analysis$s.names, SMD_S_OthN_VoF$analysis$sigma2[[which(SMD_S_OthN_VoF$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
...
The p-value for the association between duration of treatment and outcome reported was `r  round(SMD_S_OthN_DOE$metaregression_summary$pval[2],3)`).
...
| Study | `r ifelse('StudyId' %in% SMD_S_OthN_DOE$metaregression_summary$s.names, SMD_S_OthN_DOE$metaregression_summary$s.nlevels[[which(SMD_S_OthN_DOE$metaregression_summary$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_OthN_DOE$metaregression_summary$s.names, SMD_S_OthN_DOE$metaregression_summary$sigma2[[which(SMD_S_OthN_DOE$metaregression_summary$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OthN_DOE$metaregression_summary$s.names, SMD_S_OthN_DOE$metaregression_summary$s.nlevels[[which(SMD_S_OthN_DOE$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OthN_DOE$metaregression_summary$s.names, SMD_S_OthN_DOE$metaregression_summary$sigma2[[which(SMD_S_OthN_DOE$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |
...
| Study | `r ifelse('StudyId' %in% SMD_S_OthN_EI$metaregression_summary$s.names, SMD_S_OthN_EI$metaregression_summary$s.nlevels[[which(SMD_S_OthN_EI$metaregression_summary$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_OthN_EI$metaregression_summary$s.names, SMD_S_OthN_EI$metaregression_summary$sigma2[[which(SMD_S_OthN_EI$metaregression_summary$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OthN_EI$metaregression_summary$s.names, SMD_S_OthN_EI$metaregression_summary$s.nlevels[[which(SMD_S_OthN_EI$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OthN_EI$metaregression_summary$s.names, SMD_S_OthN_EI$metaregression_summary$sigma2[[which(SMD_S_OthN_EI$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |
...
The p-value for the association between total exercise and outcome reported was `r ifelse(SMD_S_OthN_TE$metaregression_summary$pval[2] < 0.001, "<0.001", sprintf("%.3f", SMD_S_OthN_TE$metaregression_summary$pval[2]))`
...
| Study | `r ifelse('StudyId' %in% SMD_S_OthN_TE$metaregression_summary$s.names, SMD_S_OthN_TE$metaregression_summary$s.nlevels[[which(SMD_S_OthN_TE$metaregression_summary$s.names == 'StudyId')]], 0)` | `r ifelse('StudyId' %in% SMD_S_OthN_TE$metaregression_summary$s.names, SMD_S_OthN_TE$metaregression_summary$sigma2[[which(SMD_S_OthN_TE$metaregression_summary$s.names == 'StudyId')]], 'NA')` |
| Study x Experiment | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OthN_TE$metaregression_summary$s.names, SMD_S_OthN_TE$metaregression_summary$s.nlevels[[which(SMD_S_OthN_TE$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 0)` | `r ifelse('StudyId/ExperimentID_I' %in% SMD_S_OthN_TE$metaregression_summary$s.names, SMD_S_OthN_TE$metaregression_summary$sigma2[[which(SMD_S_OthN_TE$metaregression_summary$s.names == 'StudyId/ExperimentID_I')]], 'NA')` |
...
**4.1 Relationship between change in locomotor activity and change in freezing behaviour**

![](plot_2_3.png)

**4.2 Relationship between change in locomotor activity and change in other behaviours**

![](plot_2_5.png)

**4.3 Relationship between change in locomotor activity and change in BDNF**

![](plot_2_6.png)

**4.4 Relationship between change in locomotor activity and change in stress response**

![](plot_2_7.png)



**4.5 Relationship between change in locomotor activity and change in other neurobehavioural outcomes**

![](plot_2_9.png)

**4.6 Relationship between change in other behaviours and change in freezing**

![](plot_3_5.png)

**4.7 Relationship between change in BDNF and change in freezing**

![](plot_3_6.png)

**4.8 Relationship between change in other neurobiological outcomes and change in freezing**

![](plot_3_9.png)

**4.9 Relationship between change in other behaviours and change in fear memory**

![](plot_4_5.png)
**4.10 Relationship between change in BDNF and change in fear memory**

![](plot_4_6.png)

**4.11 Relationship between change in BDNF and change in other behavioural outcomes**

![](plot_5_6.png)
**4.12 Relationship between change in stress response and change in other behavioural outcomes**

![](plot_5_7.png)

**4.13 Relationship between change in other neurobiological outcomes and change in other behavioural outcomes**

![](plot_5_9.png)
**4.14 Relationship between change in stress response and change in BDNF**

![](plot_6_7.png)

**4.15 Relationship between change in other neurobiological outcomes and change in BDNF**

![](plot_6_9.png)
**4.16 Relationship between change in other neurobiological outcomes and change in stress response**
